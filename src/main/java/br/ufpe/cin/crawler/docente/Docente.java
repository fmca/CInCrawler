...
public class Docente {
	...
	public enum Atributos {
		...
		email, nome, urlImagem, sala, fone, fax, areasInteresse, lattes, pagina
	}
	...
	public Docente(String nome, String urlImagem, String areasInteresse,
			String fone, String fax, String pagina, String email,
			String lattes, String sala) {
		super();
		this.setNome(nome);
